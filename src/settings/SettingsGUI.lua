...
function SettingsGUI:consoleCommandSetWageLevel(wageLevel)
...
function SettingsGUI:consoleCommandWorkerCostsEnable()
    if g_WorkerManager and g_WorkerManager.settings then
...
function SettingsGUI:consoleCommandWorkerCostsDisable()
    if g_WorkerManager and g_WorkerManager.settings then
...
function SettingsGUI:consoleCommandSetCostMode(mode)
...
function SettingsGUI:consoleCommandSetCustomRate(rate)
...
function SettingsGUI:consoleCommandResetSettings()
    if g_WorkerManager and g_WorkerManager.settings then
        ...
        if g_WorkerManager.settingsUI then
            g_WorkerManager.settingsUI:refreshUI()
        end

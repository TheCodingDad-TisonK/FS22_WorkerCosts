-- =========================================================
-- FS25 Realistic Worker Costs Mod (version 1.0.0.0)
-- =========================================================
...
function workerCosts()
    if g_WorkerManager and g_WorkerManager.settingsGUI then
        return g_WorkerManager.settingsGUI:consoleCommandHelp()
    else
...
getfenv(0)["workerCostsEnable"] = function() 
    if g_WorkerManager and g_WorkerManager.settingsGUI then
        return g_WorkerManager.settingsGUI:consoleCommandWorkerCostsEnable()
    end
...
getfenv(0)["workerCostsDisable"] = function() 
    if g_WorkerManager and g_WorkerManager.settingsGUI then
        return g_WorkerManager.settingsGUI:consoleCommandWorkerCostsDisable()
    end
    return "Worker Costs Mod not initialized"
end
...
getfenv(0)["workerCostsTest"] = function() 
    if g_WorkerManager and g_WorkerManager.settingsGUI then
        return g_WorkerManager.settingsGUI:consoleCommandTestPayment()
    end
    return "Worker Costs Mod not initialized"
end

print("========================================")
print("  Worker Costs Mod v1.0.0.0 LOADED      ")
